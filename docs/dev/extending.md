...
vanssa_sylius_slider_admin_slide_create_for_slider        /slides/new/{sliderId}
vanssa_sylius_slider_admin_slider_create_from_preset      /sliders/new/from-preset/{presetCode}
...
other thirteen exactly as Flex wrote them, a controller that is not listed is
not built:
...
```json
{
    "controllers": {
        "@vanssa/sylius-slider-plugin": {
            "slider": { "enabled": true, "fetch": "eager" },
            ...
            "rgba-color-picker": { "enabled": true, "fetch": "lazy" },
