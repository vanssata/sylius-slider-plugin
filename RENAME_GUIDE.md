...
- Full namespace: `Vanssa\SyliusSliderPlugin`
...
1. **Main plugin class file:**
   ```
   src/VanssaSyliusSliderPlugin.php → src/{CompanyName}{PluginName}.php
   ```
...
- Twig namespace references from `@VanssaSyliusSliderPlugin` to `@{CompanyName}{PluginName}`
...
| Find | Replace |
|------|---------|
| `Vanssa\SyliusSliderPlugin` | `{CompanyName}\{PluginName}` |
| `VanssaSyliusSliderPlugin` | `{CompanyName}{PluginName}` |
| `AcmeSyliusExampleExtension` | `{CompanyName}{PluginName}Extension` |
| `@VanssaSyliusSliderPlugin` | `@{CompanyName}{PluginName}` |
| `Tests\Vanssa\SyliusSliderPlugin` | `Tests\{CompanyName}\{PluginName}` |
...
- `Vanssa\SyliusSliderPlugin\VanssaSyliusSliderPlugin`
- `@VanssaSyliusSliderPlugin/templates/...`
