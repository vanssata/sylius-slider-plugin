                ...
                ->arrayNode('preview')
                    ...
                    ->children()
                        ->arrayNode('shop_entrypoints')
                            ->info('Webpack Encore entrypoints ("build:entry" or "entry") included in the admin slider preview so it is styled like the storefront (channel theme).')
                            ->scalarPrototype()->end()
                            ->defaultValue(['shop:shop-entry', 'app.shop:app-shop-entry', 'app.shop:plugin-shop-entry'])
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('presets')
                        ...
                        ->arrayNode('slider')
                            ...
                            ->children()
                                ...
                                ->arrayNode('slide_effect')
                                    ...
                                    ->end()
                                ->end()
                                ->arrayNode('arrows_position')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->arrayNode('values')->scalarPrototype()->end()->defaultValue(['overlay', 'outside', 'bottom'])->end()
                                        ->scalarNode('default')->defaultValue('overlay')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('arrows_vertical_align')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->arrayNode('values')->scalarPrototype()->end()->defaultValue(['center', 'top', 'bottom'])->end()
                                        ->scalarNode('default')->defaultValue('center')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('pagination_position')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->arrayNode('values')->scalarPrototype()->end()->defaultValue(['bottom-inside', 'bottom-outside', 'top', 'left', 'right'])->end()
                                        ->scalarNode('default')->defaultValue('bottom-inside')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('pagination_style')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->arrayNode('values')->scalarPrototype()->end()->defaultValue(['dots', 'lines', 'numbers'])->end()
                                        ->scalarNode('default')->defaultValue('dots')->end()
                                    ->end()
                                ->end()
